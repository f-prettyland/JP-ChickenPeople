...
<?php
 ...
 echo "<div class=\"panel panel-success\">";
      echo "      <div class=\"panel-heading\" style=\"background-color:#F5DA81\">";
      echo "        <h1 class=\"panel-title\"> <font size=\"5\"><a href=\"./mentee.php?id=".$row['id']."\">".$row[menteeName]."</a></font> </h1>";
      echo "      </div>";
      ...
      echo "    <h4>";
      echo "       <h1 class=\"panel-title\">";
      echo "          <font size=\"4\">Product:</font>".$row[product]."";
      echo "       </h1>";
      echo "     </br>";
      echo "       <h1 class=\"panel-title\">";
      echo "        <font size=\"4\">Location: </font>".$row[country];
      echo "      </h1>";
      echo "    </h4>";
      echo "  </div>";
      echo "</div>";
