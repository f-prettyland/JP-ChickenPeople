...
geocoder.geocode({ 'address': city_name + ", " + country_name}, function(results, status) {
    ...
    document.getElementById("other-stuff").innerHTML = "<h3> <a href=\"./mentee.php?id=" + web_location<?php echo $username ?> +"\"><img alt=\"140x140\" src= \"./photos/" + image<?php echo $username ?>+"\" class=\"img-rounded\" /></a> <a href=\"" + web_location<?php echo $username ?> +"\">" + name<?php echo $username ?> + "</a> "+<?php echo $product ?>+"</h3>"});
      }
    });
<?php
}
